...
public class Constants {
    ...
    public static List<List<Boolean>> VARS_TABLE = new ArrayList<>(){{
    ...
    public static List<List<Boolean>> VARS_CHANGED_TABLE = new ArrayList<>(){{
        add(Arrays.asList(false, false, false, false));
        add(Arrays.asList(false, false, false, false));
        add(Arrays.asList(true, true, true, true));
        add(Arrays.asList(true, true, true, true));
    ...
    public static List<Boolean> V_VALUES = new ArrayList<>(Arrays.asList(
            false, true,
            false, true,
            false, true,
            false, true,
    ...
    public static List<List<Boolean>> H_Values = new ArrayList<>(){{
        add(Arrays.asList(false, false, false, false));
        add(Arrays.asList(true, true, true, true));
        add(Arrays.asList(false, false, false, false));
        add(Arrays.asList(true, false, false, false));
